...
/* ALTER */
	...
	/* ALTER USER,ROLE <name> */
		...
		COMPLETE_WITH("BYPASSRLS", "CONNECTION LIMIT", "CREATEDB", "CREATEROLE",
					  "CREATEWH", "ENCRYPTED PASSWORD", "INHERIT", "LOGIN",
					  "NOBYPASSRLS", "NOCREATEDB", "NOCREATEWH", "NOCREATEROLE",
					  "NOINHERIT", "NOLOGIN", "NOREPLICATION", "NOSUPERUSER",
					  "PASSWORD","RENAME TO", "REPLICATION", "RESET", "SET",
					  "SUPERUSER", "VALID UNTIL", "WITH", "PROFILE",
					  "ENABLE PROFILE", "DISABLE PROFILE", "ACCOUNT");
	...
	/* ALTER USER,ROLE <name> WITH */
		...
		COMPLETE_WITH("BYPASSRLS", "CONNECTION LIMIT", "CREATEDB", "CREATEROLE",
					  ...
					  "NOINHERIT", "NOLOGIN", "NOREPLICATION", "NOSUPERUSER",
					  "PASSWORD", "RENAME TO", "REPLICATION", "RESET", "SET",
					  "SUPERUSER", "VALID UNTIL", "PROFILE", "ENABLE PROFILE",
...
/* CREATE ROLE,USER,GROUP <name> */
		...
		COMPLETE_WITH("ADMIN", "BYPASSRLS", "CONNECTION LIMIT", "CREATEDB",
					  "CREATEWH", "CREATEROLE", "ENCRYPTED PASSWORD", "IN",
					  "INHERIT", "LOGIN", "NOBYPASSRLS",
					  "NOCREATEDB", "NOCREATEWH", "NOCREATEROLE", "NOINHERIT",
