...
DECLARE_INDEX(pg_authid_rolresqueue_index, 6029, AuthIdRolResQueueIndexId, pg_authid, on pg_authid using btree(rolresqueue oid_ops));
DECLARE_INDEX(pg_authid_rolresgroup_index, 6440, AuthIdRolResGroupIndexId, pg_authid, on pg_authid using btree(rolresgroup oid_ops));
DECLARE_INDEX(pg_authid_rolprofile_index, 6441, AuthIdRolProfileIndexId, pg_authid, on pg_authid using btree(rolprofile oid_ops));
DECLARE_INDEX(pg_auth_time_constraint_authid_index, 6449, AuthTimeConstraintAuthIdIndexId, pg_auth_time_constraint, on pg_auth_time_constraint using btree(authid oid_ops));
