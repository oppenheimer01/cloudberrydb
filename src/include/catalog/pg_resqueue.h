...
/* no foreign keys */
DECLARE_UNIQUE_INDEX(pg_resqueue_oid_index, 6027, ResQueueOidIndexId, pg_resqueue, on pg_resqueue using btree(oid oid_ops));
DECLARE_UNIQUE_INDEX(pg_resqueue_rsqname_index, 6028, ResQueueRsqnameIndexId, pg_resqueue, on pg_resqueue using btree(rsqname name_ops));
/* ----------------
