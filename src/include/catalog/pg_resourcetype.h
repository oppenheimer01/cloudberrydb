...
/* no foreign keys */
DECLARE_UNIQUE_INDEX(pg_resourcetype_oid_index, 6061, ResourceTypeOidIndexId, pg_resourcetype, on pg_resourcetype using btree(oid oid_ops));
DECLARE_UNIQUE_INDEX(pg_resourcetype_restypid_index, 6062, ResourceTypeRestypidIndexId, pg_resourcetype, on pg_resourcetype using btree(restypid int2_ops));
DECLARE_UNIQUE_INDEX(pg_resourcetype_resname_index, 6063, ResourceTypeResnameIndexId, pg_resourcetype, on pg_resourcetype using btree(resname name_ops));
