...
DECLARE_UNIQUE_INDEX(gp_segment_config_content_preferred_role_warehouse_index, 7139, GpSegmentConfigContentPreferred_roleWarehouseIndexId, gp_segment_configuration, on gp_segment_configuration using btree(content int2_ops, preferred_role char_ops, warehouseid oid_ops));
DECLARE_UNIQUE_INDEX(gp_segment_config_dbid_warehouse_index, 7140, GpSegmentConfigDbidWarehouseIndexId, gp_segment_configuration, on gp_segment_configuration using btree(dbid int2_ops, warehouseid oid_ops));
