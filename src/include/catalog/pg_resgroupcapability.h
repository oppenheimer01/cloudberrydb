...
DECLARE_UNIQUE_INDEX(pg_resgroupcapability_resgroupid_reslimittype_index, 6445, ResGroupCapabilityResgroupidResLimittypeIndexId, pg_resgroupcapability, on pg_resgroupcapability using btree(resgroupid oid_ops, reslimittype int2_ops));
DECLARE_INDEX(pg_resgroupcapability_resgroupid_index, 6446, ResGroupCapabilityResgroupidIndexId, pg_resgroupcapability, on pg_resgroupcapability using btree(resgroupid oid_ops));
/* ----------------
