...
DECLARE_UNIQUE_INDEX(gp_partition_template_relid_level_index, 7168, GpPartitionTemplateRelidLevelIndexId, gp_partition_template, on gp_partition_template using btree(relid oid_ops, level int2_ops));
