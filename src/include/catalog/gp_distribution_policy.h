...
DECLARE_UNIQUE_INDEX(gp_distribution_policy_localoid_index, 7167, GpPolicyLocalOidIndexId, gp_distribution_policy, on gp_distribution_policy using btree(localoid oid_ops));
