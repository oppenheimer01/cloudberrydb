...
DECLARE_UNIQUE_INDEX(gp_fastsequence_objid_objmod_index, 6067, FastSequenceObjidObjmodIndexId, gp_fastsequence, on gp_fastsequence using btree(objid oid_ops, objmod  int8_ops));
