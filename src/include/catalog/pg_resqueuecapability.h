...
DECLARE_INDEX(pg_resqueuecapability_resqueueid_index, 6442, ResQueueCapabilityResqueueidIndexId, pg_resqueuecapability, on pg_resqueuecapability using btree(resqueueid oid_ops));
DECLARE_INDEX(pg_resqueuecapability_restypid_index, 6443, ResQueueCapabilityRestypidIndexId, pg_resqueuecapability, on pg_resqueuecapability using btree(restypid int2_ops));
/* ----------------
