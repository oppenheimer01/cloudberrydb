...
DECLARE_UNIQUE_INDEX_PKEY(gp_storage_server_oid_index, 6018, StorageServerOidIndexId, gp_storage_server, on gp_storage_server using btree(oid oid_ops));
DECLARE_UNIQUE_INDEX(gp_storage_server_name_index, 6019, StorageServerNameIndexId, gp_storage_server, on gp_storage_server using btree(srvname name_ops));

MAKE_SYSCACHE(STORAGESERVEROID, gp_storage_server_oid_index, 128);
MAKE_SYSCACHE(STORAGESERVERNAME, gp_storage_server_name_index, 128);
