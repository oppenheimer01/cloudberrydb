...
DECLARE_INDEX(pg_foreign_table_seg_relid_index, 5111, ForeignTableRelationSegIndexId, pg_foreign_table_seg, on pg_foreign_table_seg using btree(ftsrelid oid_ops));
