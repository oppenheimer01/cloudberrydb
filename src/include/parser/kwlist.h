...
PG_KEYWORD("auto", AUTO, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("combine", COMBINE, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("defaultwarehouse", DEFAULTWAREHOUSE, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("suspend", SUSPEND, UNRESERVED_KEYWORD, BARE_LABEL)
