 ...
 * outfast.c.
 *
 * This file is fully self-contained: all binary read functions are defined
 * here, using the binary READ_* macros defined below.  The text reader
 * (readfuncs.c) is independent and uses different macro implementations.
