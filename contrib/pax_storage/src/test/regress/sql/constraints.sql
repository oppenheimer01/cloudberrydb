...
COPY COPY_TBL FROM '/home/gpadmin/cloudberry/contrib/pax_storage/src/test/regress/data/constro.data';

SELECT * FROM COPY_TBL;

COPY COPY_TBL FROM '/home/gpadmin/cloudberry/contrib/pax_storage/src/test/regress/data/constrf.data';
...
-- pax not support TupleLock + TupleInsertSpeculative
